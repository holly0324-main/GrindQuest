...
export const enemies = {
  slime: { id:'slime', name:'スライム', icon:'🟦', hp:18, atk:6, def:1, exp:9, drops:[['slime_gel',.72],['herb',.18]] },
  rabbit: { id:'rabbit', name:'ツノウサギ', icon:'🐇', hp:24, atk:8, def:2, exp:12, drops:[['beast_fang',.35],['herb',.20]] },
  big_slime: { id:'big_slime', name:'キングゼリー', icon:'🔵', hp:72, atk:11, def:3, exp:42, boss:true, drops:[['slime_gel',1],['iron_ore',.55]] },
  bat: { id:'bat', name:'洞窟コウモリ', icon:'🦇', hp:36, atk:11, def:2, exp:18, drops:[['beast_fang',.35],['iron_ore',.25]] },
  goblin: { id:'goblin', name:'ゴブリン', icon:'👺', hp:46, atk:13, def:4, exp:24, drops:[['iron_ore',.55],['herb',.22]] },
  cave_wolf: { id:'cave_wolf', name:'ケイブウルフ', icon:'🐺', hp:54, atk:15, def:3, exp:28, drops:[['beast_fang',.62],['iron_ore',.20]] },
  golem: { id:'golem', name:'岩窟ゴーレム', icon:'🗿', hp:130, atk:19, def:7, exp:95, boss:true, drops:[['iron_ore',1],['magic_crystal',.45]] },
  skeleton: { id:'skeleton', name:'さまよう骸骨', icon:'💀', hp:78, atk:19, def:5, exp:40, drops:[['bone',.7],['magic_crystal',.18]] },
  imp: { id:'imp', name:'魔導インプ', icon:'👿', hp:68, atk:22, def:4, exp:44, drops:[['magic_crystal',.52],['flame_crystal',.08]] },
  armor: { id:'armor', name:'からくり甲冑', icon:'🤖', hp:92, atk:21, def:9, exp:52, drops:[['iron_ore',.62],['magic_crystal',.28]] },
  ruin_knight: { id:'ruin_knight', name:'遺跡の黒騎士', icon:'♞', hp:220, atk:27, def:10, exp:180, boss:true, drops:[['magic_crystal',1],['flame_crystal',.55]] }
};

export const dungeons = {
  green_hill: {
    id:'green_hill', name:'はじまりの丘', icon:'🌱', recommended:1, unlockLevel:1, cycleMinutes:6,
    desc:'分岐を選びながら進む短い探索路。薬草や簡単な素材が集まる。',
    enemyPool:['slime','rabbit'], boss:'big_slime', forage:['slime_gel','herb','beast_fang'],
    idle:{ exp:28, drops:{slime_gel:2.2, herb:.7, beast_fang:.45} }
  },
  echo_cave: {
    id:'echo_cave', name:'こだまの洞窟', icon:'🕳️', recommended:3, unlockLevel:3, cycleMinutes:10,
    desc:'分岐によって消耗が大きく変わる洞窟。鉄鉱石と魔獣素材が狙える。',
    enemyPool:['bat','goblin','cave_wolf'], boss:'golem', forage:['iron_ore','beast_fang','herb','magic_crystal'],
    idle:{ exp:76, drops:{iron_ore:1.7, beast_fang:1.1, herb:.35, magic_crystal:.12} }
  },
  ancient_ruins: {
    id:'ancient_ruins', name:'忘れられた遺跡', icon:'🏛️', recommended:6, unlockLevel:6, cycleMinutes:15,
    desc:'撤退判断が重要な高難度エリア。魔結晶と炎晶石を狙える。',
    enemyPool:['skeleton','imp','armor'], boss:'ruin_knight', forage:['bone','magic_crystal','iron_ore','flame_crystal'],
    idle:{ exp:155, drops:{bone:1.8, magic_crystal:1.25, iron_ore:.7, flame_crystal:.16} }
  }
};
