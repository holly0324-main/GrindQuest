...
// tag: adventure=冒険用 / material=製作用素材 / valuable=換金向け
...
export const battleSkills = {
  flame_slash:{id:'flame_slash',name:'火炎斬り',icon:'🔥',mp:3,desc:'炎をまとわせて強く斬る。'},
  heavy_slash:{id:'heavy_slash',name:'強打',icon:'💥',mp:2,desc:'力を込めた重い一撃。'}
};
export const battleSpells = {
  heal:{id:'heal',name:'ホイミ',icon:'✨',mp:4,desc:'HPを回復する。'}
};

export const backpacks = {
  cheap:{id:'cheap',name:'安物のバッグ',capacity:40,price:0,icon:'🎒'},
  canvas:{id:'canvas',name:'帆布のバックパック',capacity:70,price:360,icon:'🎒'},
  explorer:{id:'explorer',name:'冒険者の大型バッグ',capacity:110,price:1200,icon:'🧳'}
};
